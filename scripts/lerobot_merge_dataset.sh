...
lerobot-edit-dataset  \
    --repo_id ${HF_USER}/pnp_9in_plates_recover_finger_merged \
    --operation.type merge \
    --operation.repo_ids "['${HF_USER}/pnp_9in_plates_corner', '${HF_USER}/pnp_9in_plates_corner_recover', '${HF_USER}/pnp_9in_plates_corner_recover_finger_sep']"